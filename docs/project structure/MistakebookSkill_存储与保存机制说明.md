...
1. 项目级内容写到当前项目根目录下
   - 比如 `.codex/mistakebook/`、`.claude/mistakebook/`、`.vscode/mistakebook/`
2. 全局级内容写到系统用户目录下
   - 比如 `C:\Users\用户名\.codex\mistakebook\`、`C:\Users\用户名\.claude\mistakebook\`
3. 只有用户明确确认“纠错完成”后，Agent 才应该真正归档并写盘
...
| --- | --- | --- | --- |
| Codex | `<project>/.codex/mistakebook/` | `<project>/.codex/mistakebook/failures/` | `<project>/.codex/mistakebook/memory/` |
| Claude | `<project>/.claude/mistakebook/` | `<project>/.claude/mistakebook/failures/` | `<project>/.claude/mistakebook/memory/` |
| VSCode | `<project>/.vscode/mistakebook/` | `<project>/.vscode/mistakebook/failures/` | `<project>/.vscode/mistakebook/memory/` |
| Generic | `<project>/.mistakebook/` | `<project>/.mistakebook/failures/` | `<project>/.mistakebook/memory/` |

### 2.2 全局级保存位置

| 宿主 | 全局级根目录 | 错题集目录 | 记忆目录 |
| --- | --- | --- | --- |
| Codex | `~/.codex/mistakebook/` | `~/.codex/mistakebook/failures/` | `~/.codex/mistakebook/memory/` |
| Claude | `~/.claude/mistakebook/` | `~/.claude/mistakebook/failures/` | `~/.claude/mistakebook/memory/` |
| VSCode | `~/.vscode/mistakebook/` | `~/.vscode/mistakebook/failures/` | `~/.vscode/mistakebook/memory/` |
| Generic | `~/.mistakebook/` | `~/.mistakebook/failures/` | `~/.mistakebook/memory/` |
...
1. 错题案例和项目/全局记忆是按宿主分目录保存的。
2. 自动识别配置和运行时 checkpoint 却保存在通用目录 `~/.mistakebook/`。

所以它实际上是“宿主分存储 + 通用共享配置”的混合方案。
...
```text
F:\_WorkSpace\Projects\MistakebookSkill\.codex\mistakebook\
```

全局级：

```text
C:\Users\Septem\.codex\mistakebook\
```
...
```text
F:\_WorkSpace\Projects\MistakebookSkill\.claude\mistakebook\
```

全局级：

```text
C:\Users\Septem\.claude\mistakebook\
```
...
```text
F:\_WorkSpace\Projects\MistakebookSkill\.vscode\mistakebook\
```

全局级：

```text
C:\Users\Septem\.vscode\mistakebook\
```
...
1. Codex：`.codex/mistakebook/failures/`
2. Claude：`.claude/mistakebook/failures/`
3. VSCode：`.vscode/mistakebook/failures/`

### 13.2 看项目记忆

去当前项目下面找：

1. Codex：`.codex/mistakebook/memory/PROJECT_MEMORY.md`
2. Claude：`.claude/mistakebook/memory/PROJECT_MEMORY.md`
3. VSCode：`.vscode/mistakebook/memory/PROJECT_MEMORY.md`
...
1. Codex：`~/.codex/mistakebook/memory/GLOBAL_MEMORY.md`
2. Claude：`~/.claude/mistakebook/memory/GLOBAL_MEMORY.md`
3. VSCode：`~/.vscode/mistakebook/memory/GLOBAL_MEMORY.md`
